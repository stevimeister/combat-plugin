...
public final class PacketCreator {
    ...
    public PacketCreator withField(String fieldName, Object value) {
        ...
        try {
            ...
            CombatPlugin.getInstance().getLogger().info("Could not retrieve field from given packet class");
        }
    ...
    public PacketCreator withField(String fieldName, Object value, Class<?> fieldType) {
        ...
        try {
            ...
            if (! fieldType.isAssignableFrom(field.getType())) {
                CombatPlugin.getInstance().getLogger().info("Given fieldType is not assignable from found field's type");
            }
